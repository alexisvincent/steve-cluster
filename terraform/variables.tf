...
variable "subnet_long" {
  default     = "255.255.0.0"
  description = "subnet of the cluster in long (255.255.0.0) form"
}

variable "subnet_short" {
  default     = "16"
  description = "subnet of the cluster in short (16) form"
}

variable "dhcp_start" {
  default     = ""
  type = "string"
  description = "Starting address of the dhcp address allocation"
}

variable "dhcp_end" {
  default     = ""
  type = "string"
  description = "Ending address of the dhcp address allocation"
}
