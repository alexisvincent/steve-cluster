...
# Install kubectl
rm ~/.bin/kubectl
curl -O https://storage.googleapis.com/kubernetes-release/release/v1.10.0/bin/linux/amd64/kubectl
...
# Install Terraform
rm ~/.bin/terraform
wget -O /home/core/.bin/terraform.zip https://releases.hashicorp.com/terraform/0.11.5/terraform_0.11.5_linux_amd64.zip
